...
#include "Human_Healer.generated.h"

UCLASS()
class SOUL_API AHuman_Healer : public AHumanCharacter
{
	GENERATED_BODY()
...
public:
	...
	class UAnim_Human_Healer* AnimHuman;
...
public:
	...
	UFUNCTION(BlueprintPure, Category = "Human_Healer PerCollect")
